...
function authorBornIn1947(books: Book[]) {
  return books.find(book => book.author.birthYear === 1947)?.author.name

}
console.log(authorBornIn1947(books))

function smallerName(books: Book[]) {
  let nameBook:string = ''
